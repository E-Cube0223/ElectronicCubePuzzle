...
void do1(void)
{
    ...
    {
        LATBbits.LATB3 = 1;
        _delay((unsigned long)((21)*(64000000/4000000.0)));
        LATBbits.LATB3 = 0;
        _delay((unsigned long)((21)*(64000000/4000000.0)));
    }
}
...
void mi1(void)
{
    ...
    {
        LATBbits.LATB3 = 1;
        _delay((unsigned long)((22)*(64000000/4000000.0)));
        LATBbits.LATB3 = 0;
        _delay((unsigned long)((22)*(64000000/4000000.0)));
    }
}
...
void so1(void)
{
    ...
    {
        LATBbits.LATB3 = 1;
        _delay((unsigned long)((300)*(64000000/4000000.0)));
        LATBbits.LATB3 = 0;
        _delay((unsigned long)((300)*(64000000/4000000.0)));
    }
}
...
void do2(void)
{
    ...
    {
        LATBbits.LATB3 = 1;
        _delay((unsigned long)((956)*(64000000/4000000.0)));
        LATBbits.LATB3 = 0;
        _delay((unsigned long)((956)*(64000000/4000000.0)));
    }
}
