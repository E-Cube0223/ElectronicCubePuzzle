# 1 "master/SerialLED_PIC18F25K22.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "master/SerialLED_PIC18F25K22.c" 2
...
# 8 "master/SerialLED_PIC18F25K22.c" 2
...
# 9 "master/SerialLED_PIC18F25K22.c" 2
...
void OUT_LED_ARRAY(unsigned char LED_COLOR_ARRAY_2D[6][9], unsigned char LED_POWER) {
    unsigned char LED_COLOR_ARRAY[54];
    for(unsigned int j=0;j<6;j++){
        for(unsigned int i=0;i<9;i++){
            LED_COLOR_ARRAY[j*9 +i]=LED_COLOR_ARRAY_2D[j][i];
        }
    }
